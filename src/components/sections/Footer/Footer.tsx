...
const Footer: React.FC<IFooter> = (): JSX.Element => {
  ...
  return (
    <footer
      className={`bg-mainBlack pt-[130px] ${path === "/login" ? "hidden" : "block"}`}
    >
      <div className="container">
        <div
          className={`mb-10 flex justify-center gap-5 text-center md:justify-between md:text-left`}
        >
          ...
          <div
            className={`hidden w-full basis-[50%] justify-between gap-5 md:flex`}
          >
            {[
