...
const LoginImage: React.FC<ILoginImage> = ({
   className
}: ILoginImage): JSX.Element => {
   const { defaultTab } = useLoginStore()
   return (
      <div
         className={`bg-normal-red flex  basis-1/3 flex-col items-center justify-center overflow-hidden lg:h-full ${
            className
         }`}
      >
         <Image
